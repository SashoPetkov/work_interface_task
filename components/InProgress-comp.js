...
templates['InProgress'] = template({"1":function(container,depth0,helpers,partials,data) {
    var stack1;
  ...
  return "<article>\n  <header>\n    <img src=\"../Img_and_icons/gears.png\" alt=\"gears\">\n    <h1>IN PROGRESS</h1>\n    <p>6</p>\n  </header>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.inProgres : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "  <footer>\n    <h1>+ ADD TASK</h1>\n  </footer>\n</article>";
},"useData":true});
})();